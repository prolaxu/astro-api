...
// More about command line options: https://www.astro.com/cgi/swetest.exe.cgi?arg=-h&p=0

// TROPICAL ZODIAC
exec ("swetest.exe -edir$libPath -b$date -ut$time -p0123456789mt -eswe -fPls -g, -head", $output_t);
var_dump($output_t); 
...
exec ("swetest.exe -edir$libPath -b$date -ut$time -p0123456789mt -n5 -sid1 -eswe -fPls -g, -head", $output_s5);
var_dump($output_s5); 
